...
import { hookFactory as createConfirmNftsHook, UseConfirmNftsHook } from "./useConfirmNfts";
...
export type Web3Hooks = {
  ...
  useConfirmNfts: UseConfirmNftsHook;
}
...
export const setupHooks: SetupHooks = (deps) => {
  return {
    ...
    useConfirmNfts: createConfirmNftsHook(deps),
  }
}
